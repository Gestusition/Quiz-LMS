      ...
      schemas: {
        ...
        Course: {
          ...
          properties: {
            ...
            firstWeekStartsAt: { type: 'string', format: 'date-time', nullable: true },
            lastWeekEndsAt: { type: 'string', format: 'date-time', nullable: true },
            effectiveStartDate: { type: 'string', format: 'date-time', nullable: true },
            effectiveEndDate: { type: 'string', format: 'date-time', nullable: true },
            isPrevious: { type: 'boolean' },
            lifecycle: { type: 'string', enum: ['current', 'previous'] },
