...
test('preserves and normalizes the generated draft difficulty for review saves', () => {
  ...
  expect(detail.draft?.difficulty).toBe('medium');
  expect(detail.draft?.quizId).toBe(27);
  expect(detail.draft?.id).toBe(9);
